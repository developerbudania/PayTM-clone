                ...
                <div className="p-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <button onClick={async () => {
                            ...
                            if(res.data.success){
                                navigate("/paymentstatus?status=success&message=" + res.data.message);
                            } else {
                                  navigate("/paymentstatus?status=failed&message=" + res.data.message);
                            }
                        ...
                        <button
                            ...
                            className="justify-center rounded-md text-sm font-medium ring-offset-background transition-colors h-10 px-4 py-2 w-full bg-red-500 text-white cursor-pointer"
                        >
                            Cancel & Go Back
                        </button>
                    </div>
